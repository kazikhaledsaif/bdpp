...
@section('title' , 'District Committee Add')
...
@section('content')
    ...
    <section class="content-header">
        <h1>
            ...
            <small>Create a new District Committee</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Admin</a></li>
            <li class="active">New District Committee</li>
        </ol>
    </section>
    ...
    <section class="content container-fluid">
        ...
        <div class="product">
            ...
            <div class="box box-info">
                <!-- form start -->
                <form accept-charset="UTF-8" class="form-horizontal" action="{{ route('backend.district-committee.create') }}" method="post"
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputTitle" name="districtName" placeholder="Name" required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputTitle" name="districtDesignation" placeholder="Designation" required>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputTitle" name="districtDetails" placeholder="Details" >
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="email" class="form-control" id="inputTitle" name="districtEmail" placeholder="Email" >
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputTitle" name="districtMobile" placeholder="Mobile" required>
                            </div>
                        </div>
