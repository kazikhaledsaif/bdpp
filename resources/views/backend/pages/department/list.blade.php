...
@section('title' , 'Department Committee List')
...
@section('content')
    ...
    <div class="box">
        <div class="box-header">
            <div class="col-md-3">
                <h3 class="box-title">Department Committee List</h3>
            </div>

            <div class="col-md-6 ">
                <a href="{{ route('backend.department-committee.add') }}" class="btn btn-success">Add Department Committee</a>
            </div>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            <table id="product-list" class="table table-bordered table-striped table-responsive table-hover" >
                ...
                <tr>
                  ...
                  {{--      <a href="{{ route('frontend.notice.show',['id'=> $notice->slug]) }}">
                        ...
                        <a href="{{ route('backend.department-committee.edit',['id'=> $committee->id]) }}">
        ...
        $(document).on('click', '.deletebtn', function (e) {
            ...
            swal({
                ...
                if (result.value) {
                    $.ajax({
                        type: "POST",
                        url: "{{route('backend.department-committee.destroy')}}",
