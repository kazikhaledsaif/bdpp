...
@section('content')
    ...
    <div class="container mt-5">
        ...
        <h2 class="text-black text-center mb-3">Departmental Committee</h2>
                ...
                <div class="col-12 mt-3">
                    <div class="card p-3 bg-transparent">
                        <div class="card-horizontal">
                            ...
                            <div class="card-body pt-0">
                                <h3 class="card-title mb-0">জনাব মোঃ ফজলুর রহমান খান</h3>
                                <h5 class="card-title"> সাবেক সভাপতি, পিডিবি ভিপ্রকৌস ও যুগ্ম সাধারণ সম্পাদক,
                                    সিনিয়র সহ-সভাপতি। কেনিক, আইডিইবি</h5>
                                <h4 class="card-title">জ্যেষ্ঠ সহ-সভাপতি</h4>
                                <p class="card-text"></p>
                                <p class="card-text">মোবাইল: +880 1732 342404</p>
                                <p class="card-text">ই-মেইল: idebdhakadist.2002@gmail.com</p>
                            </div>
                ...
                <div class="col-12 mt-3">
                    <div class="card p-3 bg-transparent">
                        <div class="card-horizontal">
                            ...
                            <div class="card-body pt-0">
                                <h3 class="card-title mb-0">বীর মুক্তিযোদ্ধা মোঃ ইদ্রিস আলী</h3>
                                <h5 class="card-title">সাবেক সভাপতি, বাপসা কেনিপ ও শিক্ষা ও প্রশিক্ষণ
                                    বিষয়ক সম্পাদক, কেনিক, আইডিইবি।</h5>
                                <h4 class="card-title"> সহ-সভাপতি</h4>
                                <p class="card-text"></p>
                                <p class="card-text">মোবাইল: +880 1732 342404</p>
                                <p class="card-text">ই-মেইল: idebdhakadist.2002@gmail.com</p>
                            </div>
