        ...
        <div class="container district-container">
            ...
            <ul class="list-group box-shadow">
                ...
                <div class="collapse" id="collapseDhaka">
                    <a href="{{ route('frontend.districtCommittee.show',['id' => 'ঢাকা']) }}" class="list-group-item">ঢাকা</a>
                    <a href="{{ route('frontend.districtCommittee.show',['id' => 'ফরিদপুর']) }}" class="list-group-item">ফরিদপুর</a>
