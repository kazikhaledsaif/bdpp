        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="dob" class="datepicker" required>
                </div>
            </div>
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="email" class="form-control text-white" name="email" value="{{  Auth::user()->email }}" readonly  >
  ...
  {{--          <div class="col-6">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ $reference. Auth::user()->id }}" name="nosto" class="form-control text-white" disabled >
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="bkashTxId" >
                </div>
            </div>
            <div class="clearfix"></div>
